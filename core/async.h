...
public:                                                                     \
    ...
    {}                                                                      \
                                                                            \
    CompletionHandler##TSUFFIX(cbtype_t type,                               \
                               CQueueWithCtx##TSUFFIX<TENUM(T,n),           \
                                                      uintptr_t> * q,       \
                               uintptr_t ctx)                               \
        : type_(type_)                                                      \
        , h_(NULL)                                                          \
    ...
    {                                                                       \
        ...
        ASSERT(type_ != QUEUE || ((q_ && !qWithCtx_)                        \
               || (!q_ && qWithCtx_)));                                     \
                                                                            \
        if (type_ == INTERRUPT) {                                           \
            fn_ ? (h_->*fn_)(TARG(t,n))                                     \
...
{                                                                           \
    CompletionHandler##TSUFFIX<TENUM(T,n)> ch(                              \
        CompletionHandler##TSUFFIX<TENUM(T,n)>::ASYNCSCHEDULE,              \
        (CHandle *) h,                                                      \
